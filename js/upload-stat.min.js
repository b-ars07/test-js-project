...
!function(){
	function a(){
		return"function"==typeof window.getMessage?window
										.getMessage
										.apply(null,arguments):"Не найдена функция <code>getMessage</code>, которая должна быть объявлена в глобальной области видимости в файле <code>check.js</code>"
	}
	function e(){
		var a=["img/logo-background-1.jpg","img/logo-background-2.jpg","img/logo-background-3.jpg"],
			b=document.querySelector(".upload"),
	...
	function h(a,b){
		...
		switch(a){
			case c.UPLOADING:b=b||"Кексограмим&hellip;";
				break;
			case c.ERROR:d=!0,b=b||'Неподдерживаемый формат файла<br> <a href="'+document.location+'">Попробовать еще раз</a>.'
		}
	...
	var b={GIF:"gif",JPEG:"jpeg",PNG:"png","SVG+XML":"svg+xml"},
	c={ERROR:0,UPLOADING:1,CUSTOM:2},
	d=new RegExp("^image/("+Object.keys(b).join("|").replace("+","\\+")+")$","i"),
	f=document.forms["upload-select-image"],
	g=document.querySelector(".upload-message");
	...
	if("upload-file"===f.id){
		...
		if(g){
			...
			switch(h(c.UPLOADING),j.toLowerCase()){
				case b.GIF:i.indexOf("animated.gif")>-1?(l=a(!0,20),
					k="Переданное GIF-изображение анимировано и содержит 20 кадров"!==l):(l=a(!1),
					k="Переданное GIF-изображение не анимировано"!==l);
					break;
				case b["SVG+XML"]:l=a(100,75),
					k="Переданное SVG-изображение содержит 100 объектов и 300 аттрибутов"!==l;
					break;
				case b.PNG:l=a([23,11,75,88,14]),
					k="Количество красных точек во всех строчках изображения: 211"!==l;
					break;
				case b.JPEG:l=a([10,2,8,15],[4,20,5,3]),
					k="Общая площадь артефактов сжатия: 165 пикселей"!==l
				}
